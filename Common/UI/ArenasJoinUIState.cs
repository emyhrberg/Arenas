...
public class ArenasJoinUIState : UIState
{
    ...
    public override void OnActivate()
    {
        ...
        var arenasRow = new UITextActionPanel("Enter Arenas", () => SubworldSystem.Enter<ArenasSubworld>(), panelHeight, 0.5f, true, Ass.IconArenas.Value);
        var mainWorldRow = new UITextActionPanel("Enter Main World", EnterMainWorld, panelHeight, 0.5f, true, Ass.IconStartGame.Value);
