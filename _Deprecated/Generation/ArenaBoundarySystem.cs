...
//{
//    private static RasterizerState mapTextRasterizer;

//    public override void Load()
//    {
//        mapTextRasterizer = new RasterizerState
//        {
...
//    {
//        mapTextRasterizer?.Dispose();
//        mapTextRasterizer = null;
//    }
...
//            DrawClippedMapLabel(label, position, teamColor, scale, labelClip);
//        else
//            Utils.DrawBorderStringBig(Main.spriteBatch, label, position, teamColor, scale, .5f, .5f);
//    }

//    private static void DrawClippedMapLabel(string label, Vector2 position, Color color, float scale, Rectangle clip)
//    {
//        SpriteBatch batch = Main.spriteBatch;
//        GraphicsDevice graphicsDevice = Main.instance.GraphicsDevice;
//        Rectangle previousScissor = graphicsDevice.ScissorRectangle;

//        // The minimap map-icon pass uses SpriteBatch.Begin() with its default state. Restart
//        // only this label draw with scissoring enabled, then restore that exact vanilla state.
//        batch.End();
//        graphicsDevice.ScissorRectangle = clip;
//        batch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.LinearClamp,
//            DepthStencilState.None, mapTextRasterizer);
//        try
//        {
//            Utils.DrawBorderStringBig(batch, label, position, color, scale, .5f, .5f);
//        }
//        finally
//        {
//            batch.End();
