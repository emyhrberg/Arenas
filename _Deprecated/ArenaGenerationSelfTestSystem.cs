...
//        if (layout.OuterBorderThickness != 3 || ArenaLayout.BorderClearanceThickness != 3)
//            throw new InvalidOperationException("The combat perimeter must be 3 clear / 3 Lihzahrd / 3 clear tiles.");
//        if (layout.RedSpawnClearance.Height != ArenaLayout.BorderClearanceThickness
//            || layout.BlueSpawnClearance.Height != ArenaLayout.BorderClearanceThickness)
//            throw new InvalidOperationException("Team spawn boxes must coincide with the inner perimeter clearance.");
