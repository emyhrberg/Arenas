...
internal sealed class ConfigIconAttribute : Attribute
{
    ...
    internal bool GrayWhenOff { get; }

    public ConfigIconAttribute(int itemId) => ItemId = itemId;
    public ConfigIconAttribute(string assetName) => AssetName = assetName;
    public ConfigIconAttribute(string assetName, string offAssetName, bool grayWhenOff = false)
    {
        AssetName = assetName;
...
[AttributeUsage(AttributeTargets.Field | AttributeTargets.Property)]
internal sealed class RequiresFieldAttribute : Attribute
{
    internal string FieldName { get; }

    public RequiresFieldAttribute(string fieldName) => FieldName = fieldName;
}
